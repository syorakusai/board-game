...
const TIME_UP_IMAGE_VERSION = "20260807-1";
...
function showTimeout(){document.querySelector("#timeout-card-area").innerHTML=`<img src="assets/time-up-butler.png?v=${TIME_UP_IMAGE_VERSION}" alt="お時間ですと書かれた額縁を持つ老執事" onerror="this.outerHTML='<div class=&quot;missing-card&quot;>お時間ですの画像を読み込めませんでした</div>'">`;show("timeout");}
