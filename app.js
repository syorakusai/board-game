...
function showResultOpen(){document.querySelector("#result-open-card-area").innerHTML=cardMarkup(state.card);document.querySelector("#result-open-description")?.removeAttribute("hidden");document.querySelector("#selection-summary").innerHTML=selectionMarkup();show("result-open");}
